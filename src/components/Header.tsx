  ...
  return (
    <div className="w-full max-w-3xl max-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        ...
        {/* Dialog Portal => Permite mostar um componente em outro lugar da tela. Joga o conteudo para fora da aplicação, joga no body */}
        <Dialog.Portal>
          <Dialog.Overlay className="w-screen h-screen bg-black/80 fixed inset-0" />
          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <Dialog.Close className="rounded-lg first-letter:absolute right-6 top-6 text-zinc-400 hover:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-900">
